...
int main(int argc,char** argv)
{
	...
	// 	0.999											//damping_coeff
	// 	);
	// FEM::RectangleMesh *dm = new FEM::RectangleMesh(0.3,0.3,5,5);

	// double youngs_modulus = 1E4;
	// double poisson_ratio = 0.3;
	// double muscle_stiffness =1E4;
	// //Initialize Vertices
	...
	// 		// constraint_vector.push_back(new FEM::LinearMuscleConstraint(muscle_stiffness,Eigen::Vector2d::UnitX(),i0,i1,i2,1.0/6.0*(Dm.determinant()),Dm.inverse()));	
	// 	}
	// }
	// // constraint_vector.push_back(new FEM::AttachmentConstraint(50000.0,0,Eigen::Vector2d(0,0)));
	// //Initialize world
